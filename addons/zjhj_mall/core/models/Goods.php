...
class Goods extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['price', 'original_price', 'share_commission_first', 'share_commission_second', 'share_commission_third', 'weight', 'cost_price', 'rebate','is_water_bucket'], 'number'],
    ...
    {
        return VoucherPackage::find()->where(['goods_id'=>$this->id])->asArray()->all();
