...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['is_water_voucher','is_water_order','store_id', 'is_receive_xiaofeigu','user_id', 'is_pay', 'pay_type', 'pay_time', 'is_send', 'send_time', 'is_confirm', 'confirm_time', 'is_comment', 'apply_delete', 'addtime', 'is_delete', 'is_price', 'parent_id', 'is_offline', 'clerk_id', 'is_cancel', 'shop_id', 'user_coupon_id', 'give_integral', 'parent_id_1', 'parent_id_2', 'is_sale', 'mch_id', 'is_recycle', 'order_union_id', 'is_transfer', 'type', 'is_show'], 'integer'],
            [['total_price', 'pay_price', 'express_price', 'first_price', 'second_price', 'third_price', 'coupon_sub_price', 'before_update_price', 'discount', 'express_price_1', 'rebate', 'before_update_express', 'share_price','water_deduction'], 'number'],
            [['address_data', 'content','parents_order_code', 'offline_qrcode', 'integral', 'words', 'seller_comments'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'type' => '0普通订单1大转盘订单',
            'share_price' => '发放佣金的金额',
            'is_water_voucher' => '是否使用水票',
            'is_water_order' => '是否是送水订单',
