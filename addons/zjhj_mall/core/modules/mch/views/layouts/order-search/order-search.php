                ...
                <div class="mr-3 ml-3">
                    <div class="form-group row">
                        ...
                        <div class="middle-center">
                            <a href="javascript:" class="new-day btn "  style="background: #5B9BD1;color: #FFFFFF;"  data-index="7">近7天</a>
                            <a href="javascript:" class="new-day btn " style="background: #5B9BD1;color: #FFFFFF;" data-index="30">近30天</a>
                        </div>
                    </div>
                </div>
            </div>
            <div flex="dir:left">
                ...
                <div class="mr-4">
                    <div class="form-group">
                        <button class="btn  mr-4"   style="background: #5B9BD1;color: #FFFFFF">筛选</button>
