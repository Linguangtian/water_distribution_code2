            ...
            <table class="table table-bordered bg-white">
                ...
                <tr>
                    ...
                    <td class="order-tab-2">
                        ...
                        <?php if ($order_item['is_water_voucher']==1) : ?>
                            <div class='titleColor'>水票：
                                <span style="color:#5b9bd1;">-<?= $order_item['water_deduction'] ?></span>元
                            </div>
                        <?php endif; ?>
...
<!--                            <div class='titleColor'>会员折扣：<span style="color:red;">--><?//= $order_item['discount'] ?><!--</span>折</div>-->
                    ...
                    <td class="order-tab-5">
                        ...
                        <div>
                            ...
                            <?php if($order_item['is_water_order']!=1) :?>
                            ...
                            <?php else :?>
                            <a class="btn btn-sm  mt-2" style="background: #5B9BD1; color: #FFFFFF;" href="<?= $urlManager->createUrl(['mch/waterman-order/index', 'order_id'=>$order_item['id']]) ?>"/>
                                订水配送
                            </a>
                            <?php endif; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="send-form" method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-9">
                                <div class="pt-1">
                                    ...
                                    <label class="custom-control custom-radio">
                                        <input id="radio3" value="2" name="is_express" type="radio"
                                               class="custom-control-input is-express">
                                        <span class="custom-control-indicator"></span>
                                        <span class="custom-control-description">订水订单</span>
                                    </label>
                        ...
                        <div class="is-true-express2" style="display: none" id="app">
                            <input class="form-control" type="hidden" autocomplete="off" name="order_id">
                            <label>选择送水员</label>
                             <div >
                                    <div class="input-group mb-3">
                                        <input class="form-control keyword2"  name="keyword2" autocomplete="off" />
                                        <input class="form-control watrman_id"  name="watrman_id" value="" hidden>
                                        <span class="input-group-btn">
                                         <a class="btn btn-secondary search-user-form"  href="javascript:">查找</a>
                                        </span>
                                    </div>
                                    <div>
                                        <template v-if="(user_list && user_list.length)||msg.length">
                                            <div v-for="(u,i) in user_list" class="user-item"
                                                ...
                                                <div>
                                                    ...
                                                    <span>{{u.nickname}}|{{u.real_name}}|{{u.mobile}}|<a style="color: red">{{u.unconfirm_total}}</a></span>
                                                </div>
                                                <div>
                            ...
                            <label>留言 </label>
                            <textarea class="form-control" name="water_words"></textarea>
                        </div>




                        <div class="mt-2 is-true-express3"  style="display: none">
                            <label>商家留言（选填）</label>
...
<script>
    ...
    $(document).on('click', '.search-user-form', function () {
        console.info(221);
        var url = '<?= $urlManager->createUrl(['mch/waterman/waterman-list']) ?>';
        $.ajax({
            url:url,
            dataType: 'json',
            type:'get',
    ...
    $(document).on('click', '.select-user', function () {
        ...
        var user = app2.user_list[index];

        var watermanInfo=user.nickname+'|'+user.real_name+'|'+user.mobile;
        $('.keyword2').val(watermanInfo);
        $('.watrman_id').val(user.user_id);
        $('.user-item').hide();
...
/*
    ...
    $(document).on('click', '.is-express', function () {
        ...
        if ($(this).val() == 1) {
            $('.is-true-express').show();
            $('.is-true-express2').hide();
            $('.is-true-express3').hide();

        } else if ($(this).val() == 2) {
            $('.is-true-express').hide();
            $('.is-true-express2').show();
            $('.is-true-express3').hide();
        }else {
            $('.is-true-express').hide();
            $('.is-true-express2').hide();
            $('.is-true-express3').show();
        }
    });
