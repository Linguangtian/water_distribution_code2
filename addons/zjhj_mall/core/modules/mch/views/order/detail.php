                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 mb-4">
                        <table class="table table-bordered">
                            ...
                            <?php if ($order['is_water_order']==1) : ?>
                                <tr>
                                    <td colspan="2" style="text-align: center">配送信息</td>
                                </tr>
                                <tr>
                                    <td>配水员</td>
                                    <td><?= $order['waterman_info']['real_name'] ?> </td>
                                </tr>
                                <tr>
                                    <td>配水员编号</td>
                                    <td><?= $order['waterman_info']['code'] ?></td>
                                </tr>
                                <tr>
                                    <td>电话</td>
                                    <td><?=  $order['waterman_info']['mobile'] ?></td>
                                </tr>

                                <tr>
                                    <td>微信号</td>
                                    <td><?=  $order['waterman_info']['wechat_code'] ?></td>
                                </tr>

                                <tr>
                                    <td>订单水桶数</td>
                                    <td><?=  $order['waterman_info']['order_bucket'] ?></td>
                                </tr>
                                <?php if ($order['waterman_info']['water_words']) : ?>
                                    <tr>
                                        <td>备注</td>
                                        <td><?=  $order['waterman_info']['water_words'] ?></td>
                                    </tr>
                                <?php endif; ?>
                            <?php endif; ?>
