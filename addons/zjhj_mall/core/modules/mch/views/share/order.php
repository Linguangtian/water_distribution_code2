                    ...
                    <div flex="dir:left">
                        <div class="mb-3">
                            <div class="input-group">
								...
								<!--<select onchange="shuaixuan()" id="personList">-->
								<select onchange="tijiao()" id="personList" name="parent_id">
								  <option value ="0">请选择分销员</option>
								  <option value ="22">秋浪</option>
								  <option value="13">美容</option>
								  <option value="78">马淑莲</option>
								  <option value="7">小玉</option>
								  <option value="4">英英</option>
								  <option value="12">娇娇</option>
								  <option value="54">龙丽娅</option>
								</select>
                            </div>
