        ...
        <div class="">
            <form method="post" class="form auto-form" autocomplete="off"
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        <div class="form-group-label col-sm-2 text-right">
                            <label class="col-form-label">水票禁用</label>
                        </div>
                        <div class="col-sm-6">
                            <label class="radio-label">
                                <input id="radio2" <?= $user->limit_voucher == 1 ? 'checked' : null ?>
                                       value="1"
                                       name="limit_voucher" type="radio" class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">是</span>
                            </label>
                            <label class="radio-label">
                                <input id="radio2" <?= $user->limit_voucher == 0 ? 'checked' : null ?>
                                       value="0"
                                       name="limit_voucher" type="radio" class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">否</span>
                            </label>
                            <div style="color: red;">禁止后，用户将无法使用水票下单</div>
                        </div>
                    </div>
