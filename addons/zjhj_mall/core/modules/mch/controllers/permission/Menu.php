    ...
    public static function getMenu()
    {
        return [
            ...
            [
                ...
                'children' => [
                    ...
                    [
                        'name' => '分类轮播图',
                        'is_menu' => true,
                        'route' => 'mch/store/cat-slide',
                        'sub' => [
                            [
                                'name' => '分类轮播图(S|U)',
                                'is_menu' => false,
                                'route' => 'mch/store/cat-slide-edit',
                            ],
                        ],
                        'action' => [
                            [
                                'name' => '分类轮播图删除',
                                'route' => 'mch/store/cat-slide-del',
                            ]
                        ]
                    ],
                    [
            ...
            [
                'name' => '订水业务',
                'is_menu' => true,
                'route' => 'mch/voucher/voucher',
                'icon' => 'icon-services',
                'children' => [
                    [
                        'name' => '操作记录',
                        'is_menu' => true,
                        'route' => 'mch/voucher/index',
                        'sub' => [
                            [
                                'name' => '订单明细',
                                'is_menu' => false,
                                'route' => 'mch/voucher/order-detail',
                            ]
                        ],
                    ...
                    [
                       'name' => '用户水票列表',
                         'is_menu' => true,
                        'route' => 'mch/voucher/user-voucher-list',

                    ],
                    [
                       'name' => '水票列表',
                         'is_menu' => true,
                        'route' => 'mch/voucher/voucher-list',

                    ],
                    [
                        'name' => '送水员',
                        'is_menu' => true,
                        'route' => 'mch/waterman/index',
                        'sub' => [
                            [
                                'name' => '添加送水员',
                                'is_menu' => false,
                                'route' => 'mch/waterman/waterman-add',
                            ], [
                                'name' => '编辑送水员',
                                'is_menu' => false,
                                'route' => 'mch/waterman/waterman-edit',
                            ],
                        ]
                    ...
                    [
                        'name' => '配送订单',
                        'is_menu' => true,
                        'route' => 'mch/waterman-order/index',
                    ],
                    [
                    'name' => '水桶管理',
                    'is_menu' => true,
                    'route' => 'mch/waterman-order/bucket',
                    'sub' => [
                          [
                                'name' => '添加送水员',
                                'is_menu' => false,
                                'route' => 'mch/waterman-order/bucket-edit',
                          ]
                    ]
