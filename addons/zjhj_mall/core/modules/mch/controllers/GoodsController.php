...
class GoodsController extends Controller
{
    ...
    public function actionGoodsEdit($id = 0)
    {
        ...
        if (\Yii::$app->request->isPost) {
            ...
            $form->voucher_package = \Yii::$app->request->post('voucher_package');
            $form->setting_voucher = \Yii::$app->request->post('setting_voucher');
            $form->voucher_dsc = \Yii::$app->request->post('voucher_dsc');
        ...
        //获取优惠卷列表
        if($goods['setting_voucher']){
          $voucherForm =new VoucherPackageForm();
          $voucherForm->goods_id=$goods['id'];
          $voucherForm->store_id=$this->store;
          $voucher_list=$voucherForm->getVoucherList();
        }
