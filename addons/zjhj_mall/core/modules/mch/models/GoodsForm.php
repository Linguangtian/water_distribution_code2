...
class GoodsForm extends MchModel
{
    ...
    public $attr;
    public $unit;
    public $voucher_package;
    public $setting_voucher;
    public $voucher_dsc;
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'share_type', 'quick_purchase', 'hot_cakes', 'is_level', 'is_negotiable','setting_voucher','is_water_bucket'], 'integer'],
            [['price', 'original_price'], 'number', 'min' => 0.01, 'max' => 999999],
            [['detail', 'service', 'cover_pic', 'video_url', 'goods_no','voucher_dsc'], 'string'],
    ...
    public function attributeLabels()
    {
        return [ 
            ...
            'setting_voucher' => '是否开启抵用券',
            'is_water_bucket' => '是否存在水桶',
        ];
    }
    ...
    public function save()
    {
        if ($this->validate()) {
            ...
            $goods->voucher_dsc = $this->voucher_dsc;
            $goods->setting_voucher = $this->setting_voucher ? 1 : 0;
            $goods->is_water_bucket = $this->is_water_bucket ? 1 : 0;
    ...
    public function getVoucherPackage(){
