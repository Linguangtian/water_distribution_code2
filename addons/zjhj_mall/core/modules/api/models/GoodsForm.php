...
class GoodsForm extends ApiModel
{
    ...
    public function search()
    {
        ...
        $VoucherPackage=$goods->setting_voucher?$goods->getVoucherPackage():'';
        $data = [
            'id' => $goods->id,
            'pic_list' => $pic_list,
            'attr' => $goods->attr,
            ...
            'voucher_package' => $VoucherPackage,
            'setting_voucher' => $goods->setting_voucher,
            'voucher_dsc' => $goods->voucher_dsc,
        ];
